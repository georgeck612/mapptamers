...
global_hierarchical_clusterer <- function(method, dists, metric) {
  ...
  plot_dendrogram(global_linkage, method, max_dist, cut_height, paste(paste(toupper(substr(method, 1, 1)), substr(method, 2, nchar(method)), sep=""), "linkage"), paste(metric, "distance"))
